...
OUTPUT_JSON = (
    EXPERIMENTS
    / "conf-004a-convergence-specificity-v1.json"
)

OUTPUT_NPZ = (
    EXPERIMENTS
    / "conf-004a-convergence-specificity-v1.npz"
)
...
def main():
    ...
    print("=" * 110)
    print("CONF-004A CONVERGENCE AND SPECIFICITY")
    print("=" * 110)
    ...
    artifact = {
        "schema":
            "conf-004a-convergence-specificity-v1",
    ...
    print()
    print("=" * 110)
    print("CONF-004A CONVERGENCE RUN COMPLETE")
    print("=" * 110)
