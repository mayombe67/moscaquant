...
from brain.hybrid_visual_transduction import (
    HybridVisualTransductionRuntime,
)
...
OUTPUT = data_path('experiments', 'mq3-1-hybrid-neutral-calibration-v1.json')
