...
OUTPUT_NPZ = (
    EXPERIMENTS
    / "conf-004a-generalized-intervention-matrix-v1.npz"
)
...
def main():
    ...
    print("=" * 100)
    print("CONF-004A GENERALIZED INTERVENTION MATRIX")
    print("=" * 100)
    ...
    artifact = {
        "schema":
            "conf-004a-generalized-intervention-matrix-v1",

        "experiment_id":
            "conf-004a-generalized-13-edge-v1",
        ...
        "encoder": {
            ...
            "scale":
                "1.4826_x_median_absolute_deviation",
        ...
        "robustness_test": {
            ...
            "changed_component":
                "market_feature_normalization",

            "causal_frames_reselected":
                False,

            "causal_nodes_reselected":
                False,
    ...
    print()
    print("=" * 100)
    print("CONF-004A GENERALIZED MATRIX COMPLETE")
    print("=" * 100)
