...
OUTPUT_JSON = (
    EXPERIMENTS
    / "conf-004a-pathway-56393-68045-1273-v1.json"
)

OUTPUT_NPZ = (
    EXPERIMENTS
    / "conf-004a-pathway-56393-68045-1273-v1.npz"
)
...
def main():
    ...
    print("=" * 100)
    print("CONF-004A PATHWAY PERTURBATION")
    print("=" * 100)
    print()
    print(
        f"{UPSTREAM} -> "
    ...
    artifact = {
        "schema":
            "conf-004a-pathway-56393-68045-1273-v1",
    ...
    print()
    print("=" * 100)
    print("CONF-004A PATHWAY RUN COMPLETE")
    print("=" * 100)
